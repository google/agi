...
// applyMemWrite marks or creates the memoryWrites of wmap affected by (p, s)
// as being writes of node n. It returns true if this is a new write by n.
...
// wmap that interesects with (p, s)
