...
// NewDestroyResourcesAtEOS creates a transform that destroys all active
...
func (dropTransform *destroyResourcesAtEOS) EndTransform(ctx context.Context, inputCommands []api.Cmd, inputState *api.GlobalState) ([]api.Cmd, error) {
	return append(inputCommands, dropTransform.addCleanUpCommands(ctx, inputState)...), nil
}
...
func (dropTransform *destroyResourcesAtEOS) addCleanUpCommands(ctx context.Context, inputState *api.GlobalState) []api.Cmd {
