---
title: Supported Vulkan Extensions
layout: default
...
VK_KHR_bind_memory2                       | Yes     | Core in Vk 1.1
VK_KHR_dedicated_allocation               | Yes     | Core in Vk 1.1
VK_KHR_descriptor_update_template         | Yes     | Core in Vk 1.1
VK_KHR_device_group                       | No      | Core in Vk 1.1
VK_KHR_device_group_creation              | No      | Core in Vk 1.1
VK_KHR_external_fence                     | No      | Core in Vk 1.1
VK_KHR_external_fence_capabilities        | Yes     | Core in Vk 1.1
VK_KHR_external_memory                    | No      | Core in Vk 1.1
VK_KHR_external_memory_capabilities       | Yes     | Core in Vk 1.1
VK_KHR_external_semaphore                 | No      | Core in Vk 1.1
VK_KHR_external_semaphore_capabilities    | Yes     | Core in Vk 1.1
VK_KHR_get_memory_requirements2           | Yes     | Core in Vk 1.1
VK_KHR_get_physical_device_properties2    | Yes     | Core in Vk 1.1
VK_KHR_maintenance1                       | Yes     | Core in Vk 1.1
VK_KHR_maintenance2                       | Yes     | Core in Vk 1.1
VK_KHR_maintenance3                       | Yes     | Core in Vk 1.1
VK_KHR_multiview                          | No      | Core in Vk 1.1
VK_KHR_relaxed_block_layout               | No      | Core in Vk 1.1
VK_KHR_sampler_ycbcr_conversion           | Yes     | Core in Vk 1.1
VK_KHR_shader_draw_parameters             | Yes     | Core in Vk 1.1
VK_KHR_storage_buffer_storage_class       | Yes     | Core in Vk 1.1
VK_KHR_variable_pointers                  | Yes     | Core in Vk 1.1
VK_KHR_8bit_storage                       | No      |
...
VK_KHR_sampler_mirror_clamp_to_edge       | No      |
VK_KHR_shader_atomic_int64                | No      |
VK_KHR_shader_clock                       | No      |
VK_KHR_shader_float16_int8                | No      |
VK_KHR_shader_float_controls              | No      |
