...
set +e
${LUCI_CLIENT_ROOT}/swarming.py collect ${SWARMING_AUTH_FLAG} --swarming ${SWARMING_SERVER} --task-summary-json=${SWARMING_SUMMARY} --task-output-stdout=none 4b9e130d46ec3e10
SWARMING_COLLECT_EXIT_CODE=$?
set -e

cat ${SWARMING_SUMMARY}
