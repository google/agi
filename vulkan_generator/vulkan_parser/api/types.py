...
@dataclass
class VulkanType:
  """Base class for a Vulkan Type.

  All the other Types should inherit from this class
  """
...
class VulkanTypeAlias(VulkanType):
  """Base class for a Vulkan Alias.

  All the other aliases should inherit from this class
  """
...
class ExternalType(VulkanType):
  ...
  This is actually not a Vulkan type but because its referenced from Vulkan
  types frequently
...
class VulkanCommandInfo:
  ...
  This class should have all the information needed to generate code for
  commands
  """
...
class VulkanFeatureSet:
  ...
  enum_field_aliases: Dict[str, VulkanEnumFieldAlias] = field(
...
class SpirvCapability:
  ...
  Attribures:
      ...
      property    This capability enables
      'vk*Properties::property_group::property'
  """
...
class SpirvMetadata:
  ...
  This class should have all the information needed to generate code related to
  Spirv
  """
