...
def process_include(
    vulkan_types: internal_types.AllVulkanTypes, include_element: ET.Element
) -> None:
...
def process_defines(
    vulkan_types: internal_types.AllVulkanTypes, define_element: ET.Element
) -> None:
...
def process_external_type(
    vulkan_types: internal_types.AllVulkanTypes,
    external_type_element: ET.Element,
) -> None:
...
def process_bitmask_alises(
    vulkan_types: internal_types.AllVulkanTypes, bitmask_element: ET.Element
) -> None:
...
def process_enum_alises(
  ...
  if vulkan_enum_value_alias:
    vulkan_types.enum_aliases[vulkan_enum_value_alias.typename] = (
        vulkan_enum_value_alias
    )


def process_handle(
    vulkan_types: internal_types.AllVulkanTypes, handle_element: ET.Element
) -> None:
  """Parse the Vulkan type "Handle".

  This can be an handle or an alias to another handle
  """
...
def process_union(
    vulkan_types: internal_types.AllVulkanTypes, union_element: ET.Element
) -> None:
...
def process_struct(
    vulkan_types: internal_types.AllVulkanTypes, struct_element: ET.Element
) -> None:
  """Parse the Vulkan type "Struct".

  This can be a struct or an alias to another struct
  """
...
def process_funcpointer(
    vulkan_types: internal_types.AllVulkanTypes, func_ptr_element: ET.Element
) -> None:
