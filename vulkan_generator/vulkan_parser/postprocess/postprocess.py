...
def process(
    internal_metadata: internal_types.VulkanMetadata,
) -> types.VulkanInfo:
  """Post process all the internal structure for public API

  This will link all the referred type each other for preventing a stringly
  typed API
  """
  ...
  spirv_metadata = spirv.process(
      internal_metadata.spirv_metadata,
      all_defines,
      all_types,
      core_versions,
      extensions,
