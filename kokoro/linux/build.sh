...
# Newer version
curl -fsSL -o luci-py.tar.gz https://chromium.googlesource.com/infra/luci/luci-py.git/+archive/90dafba2b9e7df0386d4d78dbbc4bb144dc1907c.tar.gz
mkdir luci-py-recent
